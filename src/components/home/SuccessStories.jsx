...
const STORIES = [
  ...
  },
  {
    ...
    stat: '75 → 68 kg',
    statLabel: 'Cholesterol Managed',
    trend: 'loss',
    image: 'https://www.sehatplus.in/wp-content/uploads/2024/06/te2.jpg',
    text: 'Lost 7 kg in 4 months and my LDL dropped from 122 to 54. Triglycerides and total cholesterol came down from 180 to 112.',
  },
  {
    name: 'Madhuri',
    stat: '12 kg',
    ...
    text: 'Lost 12 kg and noticed a remarkable improvement in my skin texture. I now have sustained energy levels throughout the day.',
  },
  {
    name: 'Kusum',
    stat: 'Asthma',
    statLabel: 'Resolved in 3 Months',
    trend: 'gain',
  ...
  },
  {
    name: 'Raju',
    stat: 'HbA1c 5.2%',
    statLabel: 'Diabetes Controlled',
    trend: 'loss',
    image: 'https://www.sehatplus.in/wp-content/uploads/2024/06/te5.jpg',
    text: 'Lost 6–7 kg in 3 months and my HbA1c came down to 5.2%. My walking capacity improved from just 5 minutes to 45 minutes.',
  },
  {
    name: 'Rahul',
    stat: '10.9 → 5.10%',
    statLabel: 'HbA1c in 6 Months',
    trend: 'loss',
    image: 'https://www.sehatplus.in/wp-content/uploads/2024/06/te6.jpg',
    text: 'My HbA1c dropped from 10.9% to 5.10% in just 6 months. Diabetes medications discontinued and fat percentage reduced from 25.5% to 22.9%.',
  },
  {
    name: 'Smita Kate',
    stat: '9 kg',
    statLabel: 'Weight Lost in 2 Months',
    trend: 'loss',
    image: 'https://www.sehatplus.in/wp-content/uploads/2022/12/Smita-Kate-Icon.png',
    text: 'Lost 9 kg in just 2 months. Acne reduced noticeably and hair growth improved. I now maintain sustainable eating habits effortlessly.',
  },
  {
    name: 'Riya Bora',
    stat: '3 kg',
    statLabel: 'Weight Lost in 3 Months',
    trend: 'loss',
    image: 'https://www.sehatplus.in/wp-content/uploads/2022/12/Riya-Bora-Icon.png',
    text: 'At just 8 years old, I lost 3 kg in 3 months. I learned portion control and healthy eating principles that I carry forward every day.',
  },
];

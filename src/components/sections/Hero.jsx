  ...
  return (
    <section className="relative min-h-[90vh] flex items-center justify-center pt-20 overflow-hidden bg-white">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
        <div className="absolute -top-[10%] -left-[5%] w-[40%] h-[60%] bg-[color:var(--sp-primary)]/10 rounded-full blur-[120px]" />
        <div className="absolute top-[20%] -right-[10%] w-[50%] h-[70%] bg-[color:var(--sp-primary)]/10 rounded-full blur-[150px]" />
      </div>
      ...
      <div className="container relative z-10 text-center px-6">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/50 backdrop-blur-md border border-gray-100 mb-8 animate-fade-in shadow-sm">
          <span className="w-2 h-2 rounded-full bg-[var(--sp-primary)]" />
          <span className="text-sm font-semibold tracking-wide text-[var(--sp-primary)] uppercase">Evidence-Based Wellness</span>
        </div>

        <h1 className="max-w-4xl mx-auto mb-8 animate-fade-in stagger-1">
          Rooted in Science,{' '}
          <span className="italic font-normal text-[var(--sp-primary)]">Refined by Results.</span>
        </h1>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-fade-in stagger-3">
          ...
          <button className="btn-secondary flex items-center gap-2 px-8 py-4 bg-white/80 backdrop-blur-sm border border-gray-200 shadow-sm rounded-full">
            <div className="w-8 h-8 rounded-full bg-[color:var(--sp-primary)]/10 flex items-center justify-center p-2">
              <Play size={14} className="text-[var(--sp-primary)] fill-[var(--sp-primary)]" />
            </div>
            How We Work
          </button>
        </div>

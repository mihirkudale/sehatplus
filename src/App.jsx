        ...
        <div className="container mx-auto">
          ...
          >
            <div className="text-center md:text-left flex-1">
              <h3 className="text-4xl md:text-5xl font-black mb-4 font-serif italic text-white">Book an Appointment & Subscribe</h3>
              <p className="text-white/80 font-bold text-lg uppercase tracking-widest">Transform your health with Sehat+</p>
            </div>
